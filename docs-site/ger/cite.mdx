...
- **Anchor incident titles** — sourced from the [AI Incident Database](https://incidentdatabase.ai), CC BY-NC-SA 4.0. SVRNOS displays titles and links out for full narratives; we do not redistribute the corpus.
