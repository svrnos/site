...
description: "Generate a structured evidence document for an AI-incident filing. Pure deterministic — no AI in the receipt."
---

import GerReceipt from "/components/GerReceipt.jsx"

<GerReceipt />

## What this is

A **diagnostic receipt** is a structured document you take to a regulator, insurer, vendor, or class-action attorney when filing an AI-incident claim. It has four fixed sections:
...
If you don't know which codes apply to your case, start with the [lookup tool](/ger/find). The tool narrows 71+ codes to a short list of candidates based on your symptoms, the incident you observed, or the sector / harm-type filter. You read the candidates and pick the ones that fit.
