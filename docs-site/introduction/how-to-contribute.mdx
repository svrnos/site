...
- **Incident reports.** SVRNOS does not host an incident corpus. We map against the [AI Incident Database](https://incidentdatabase.ai). Report incidents there — we'll inherit the mapping.
