---
title: "The Escalation Path Has to Survive the Institution Around It"
dek: "Detection is not enough. OpenAI validated the category. The courts are pricing the gap. Regulation is moving toward the runtime layer."
description: "OpenAI's Trusted Contact validated detection-to-escalation as a product category. The Tumbler Ridge lawsuits expose the failure mode that begins after detection. The EU AI Act turns chatbot safety into operational infrastructure on August 2, 2026. Detection is not enough — the escalation path has to survive the institution around it."
date: 2026-05-12
indexCategory: governance
group: "Multi-turn safety & litigation"
hero:
  src: /insights/detection-is-not-enough/detection-is-not-enough-title.png
  alt: "Detection is not enough — the escalation path: detection, human review, notification, logging and audit trail — overridable and invisible without Sango Guard's governed runtime infrastructure"
ogImageAlt: "Detection is not enough. The escalation path has to survive the institution around it. SVRNOS."
related:
  - label: "When Detection Fires but Nothing Stops"
    href: /insights/when-detection-fires-but-nothing-stops
  - label: "GER-501, The Tumbler Ridge Pattern"
    href: /insights/ger-501-tumbler-ridge
  - label: "Washington Just Made Distress Routing a Legal Requirement"
    href: /insights/wa-distress-routing-mandate
callout: "**Operating a high-risk conversational product?** [Sango Guard](https://kingsango.com/guard) ships governed runtime infrastructure — multi-turn detection, pre-declared thresholds, override visibility, and incident reconstruction. [Request access ›](/access)"
sources:
