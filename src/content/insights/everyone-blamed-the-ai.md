---
title: "Everyone Blamed the AI"
metaTitle: "Everyone Blamed the AI: The Big Four Report Scandals Are a Quality-Control Failure"
dek: "Three of the Big Four pulled AI-written reports in eight months. The headlines blamed the AI. The failure underneath is older than that."
description: "KPMG, EY, and Deloitte each pulled or corrected a report after AI-fabricated citations surfaced. Blaming the AI is the comfortable story. It is a quality-control failure that AI made easy, and the name you give it decides what you fix."
date: 2026-06-15
indexCategory: governance
group: "General"
hero:
  src: /insights/everyone-blamed-the-ai/everyone-blamed-the-ai-hero.png
  alt: "A 1990s beige CRT computer beside a modern laptop showing a chat window on the same desk, with a yellow Post-it note in front reading: it's not me, it's the computer."
ogImageAlt: "A 1990s beige CRT computer beside a modern laptop chat window, with a Post-it note reading: it's not me, it's the computer."
related:
...
sources:
  - 'GPTZero investigation into the KPMG report ([gptzero.me](https://gptzero.me/news/investigations-kpmg/))'
  - 'GPTZero investigation into the EY loyalty-fraud report ([gptzero.me](https://gptzero.me/investigations/ey))'
  - 'Financial Times, reporting on the KPMG and EY withdrawals'
  - 'The Guardian, on Deloitte''s partial refund to the Australian government, October 2025'
cta:
...
If KPMG had an AI-specific control that failed, an undisclosed-use rule, a logging requirement, a gate on model output, that would be a real governance question. Nothing in the public record shows one. The fabricated footnote, the source that says nothing like what you claimed, the number that appears twice for two different things, none of it is new. What AI changed is the speed and the finish. The output looks done. A made-up reference is formatted exactly like a real one, so the distance between work that was checked and work that only looks checked stopped being visible to the eye. Checking was always what closed that distance. Checking is what got skipped.
