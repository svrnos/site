---
title: "When the AI Answers and Then Unmakes the Answer"
metaTitle: "GER-205 - Reset Content (informally: the Yo-Yo trick): When the AI Answers and Then Unmakes the Answer"
description: "On April 27, 2026, Meta's Llama began generating a governance research response and then retroactively suppressed it. A live instance of a failure mode the taxonomy didn't yet have a name for."
date: 2026-04-27
indexCategory: governance
gerCode: GER-205
categoryBreadcrumb: "GER-205, Reset Content (informally: the Yo-Yo trick)"
group: "Governance Error Register"
hero:
  src: /insights/ger-205/ger-205-title.png
  alt: "GER-205 - Reset Content (informally: the Yo-Yo trick)"
ogImageAlt: "GER-205 Reset Content - when the AI answers and unmakes the answer. SVRNOS."
taxonomy:
  label: "SVRNOS Governance Error Register, 205"
  href: /research/governance-error-register
related:
  - label: "The Tumbler Ridge 501"
    href: /insights/ger-501-tumbler-ridge
  - label: "Oregon SB 1546"
    href: /insights/oregon-sb-1546
callout: "**Submit a real-world instance.** If you have witnessed or documented a real-world instance of a **205, Reset Content**, or any other code in the register, [click here to submit ›](/ask). The assistant will classify your observation and route it for editorial review. See the [full register](/research/governance-error-register) for all 26 codes."
---
